...
//               <Link
//                 to="/app"
//                 className="block bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
//               >
...
//               <Link
//                 to="/referent"
//                 className="block bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-200 focus:outline-none focus:ring-2 focus:ring-green-500"
//               >
...
//               <Link
//                 to="/ai-chat"
//                 className="block bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500"
//               >
